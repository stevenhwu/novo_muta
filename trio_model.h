...
public:
  ...
  double MutationProbability(ReadDataVector data_vec);
  // Get and set methods.
  ...
  double *nucleotide_frequencies();
  void set_nucleotide_frequencies(double frequencies[kNucleotideCount]);
  double dirichlet_dispersion();
...
private:
  ...
  Array3_16d SequencingProbabilityMat(ReadDataVector data_vec);
  ...
  double nucleotide_frequencies_[kNucleotideCount];
