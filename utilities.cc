 ...
 * @param  p     RowVector of probabilities associated with each entry in the
 *               samples generated by range.
 * @return       Random element based on p probabilities from samples generated
 *               by range.
 */
int RandomChoice(int range, const RowVectorXd &p) {
 ...
 *               by range.
 */
RowVectorXi RandomChoice(int range, const RowVectorXd &p, int size) {
