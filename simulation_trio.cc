 ...
 * coverage. The population mutation rate is set to 0.01. The germline and
 * somatic mutation rates are set to 1e-6.
 *
...
int main(int argc, const char *argv[]) {
  ...
  params.set_germline_mutation_rate(0.00001);
  params.set_somatic_mutation_rate(0.00001);
